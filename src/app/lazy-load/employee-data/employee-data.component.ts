...
export class EmployeeDataComponent implements OnInit {
 ...
 this.empForm.reset()
  ...
  zeroSalaryCheckValidator(control:FormControl){
    if(control.value!==undefined && (isNaN(control.value) || control.value.startsWith(0) )){
      
      console.log(control.value)
      return{zeroSalaryCheckValidator:true}
    }
    return null;
  }
